    ...
    <section class="faq-section settings-section">
      ...
      <div class="faq-section__description">
        <div class="faq-section__text">
          <p>Minesweeper is a game where mines are hidden in a grid of squares. Safe squares have numbers telling you how many mines touch the square. 
          ...
          <p>Our Minesweeper always makes the first click safe. You open squares with the left mouse button (or just click if your are on mobile or tablet) and put flags on mines with the right mouse button (or long press if your are on mobile or tablet).
             Pressing the right mouse button (or long press if your are on mobile or tablet) again changes your flag into a questionmark. 
          ...
          <p>The three difficulty levels are Beginner (10x10 with 10 mines), Intermediate (15x15 with 35 mines) and Expert (25x25 with 99 mines). 
            The game ends when all safe squares have been opened. Minesweeper can save up to 10 winning results of yours.
          </p>
    
          <p>You also can play Custom games up to 1225 squares with a minimum of 10 mines and maximum of (x-1)(y-1) mines.</p>
    
          <p>Above the grid you can see the game timer, mines quantity, moves counter and flags counter.</p>
        </div>
